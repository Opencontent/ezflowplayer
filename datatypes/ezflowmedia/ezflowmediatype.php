    ...
    */
    function postInitializeObjectAttribute( $contentObjectAttribute, $currentVersion, $originalContentObjectAttribute )
    {
        ...
        else
        {
         ...
         //   $pluginPage = ezflowMediaType::pluginPage( $contentClassAttribute->attribute( 'data_text1' ) );
 ...
 */
    ...
    */
                             ...
                             &$result )
    {
        ...
        {
            $result['errors'][] = array( 'description' => ezpI18n::tr( 'extension/ezflowplayer/datatypes/flowmedia',
